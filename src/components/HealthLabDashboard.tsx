    ...
    <div className="h-full flex flex-col bg-black/20 backdrop-blur-xl overflow-hidden">
      ...
      <div className="p-4 md:p-6 border-b border-green-500/20">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Heart className="h-5 md:h-6 w-5 md:w-6 text-green-400" />
            <h1 className="text-xl md:text-2xl font-bold text-white">Health Lab</h1>
          </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 md:space-y-8">
        ...
        <div className="space-y-4">
          ...
          {/* Protocol Form */}
          {showProtocolForm && (
            <div className="bg-black/40 backdrop-blur-xl border border-green-500/30 rounded-lg p-4 md:p-6 space-y-4">
              ...
              />
                 ...
                 <Button onClick={handleCreateProtocol} className="bg-green-500 hover:bg-green-600 text-white min-h-[44px]">
                   Create Protocol
                 </Button>
                 <Button onClick={() => setShowProtocolForm(false)} variant="outline" className="border-gray-500 text-black hover:bg-gray-100 min-h-[44px]">
                   Cancel
                 </Button>
               </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          {showQuitHabitForm && (
            <div className="bg-black/40 backdrop-blur-xl border border-green-500/30 rounded-lg p-4 md:p-6 space-y-4">
              ...
              />
                             <div className="flex flex-col sm:flex-row gap-2">
                 <Button onClick={handleCreateQuitHabit} className="bg-green-500 hover:bg-green-600 text-white min-h-[44px]">
                   Start Tracking
                 </Button>
                 <Button onClick={() => setShowQuitHabitForm(false)} variant="outline" className="border-gray-500 text-black hover:bg-gray-100 min-h-[44px]">
                   Cancel
                 </Button>
               </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {Object.values(quitHabits).filter(habit => habit.isActive).map((habit) => {
              ...
              return (
                <div key={habit.id} className="bg-black/40 backdrop-blur-xl border border-green-500/30 rounded-lg p-4 md:p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                          <Button
                            ...
                            size="sm"
                            className="bg-green-500/20 text-green-400 hover:bg-green-500/30 border-green-500/30 min-h-[40px]"
                          >
                            Save
                          </Button>
                          <Button
                            ...
                            variant="ghost"
                            size="sm"
                            className="border-gray-500 text-white hover:bg-gray-100/10 min-h-[40px]"
                          >
                            Cancel
                          </Button>
                        </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-black/40 border-green-500/30 text-white placeholder-gray-400 focus:border-green-400 min-h-[44px]"
